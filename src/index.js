...
const REG = {
  ...
  landed: { label: 'Landed Cost', group: 'Inventory & Procurement', table: 'landed_costs', seq: null,
    search: ['cost_type'], cols: [T('po_id', 'Purchase Order', 'select', { lookup: 'pos', lv: 'id', ll: 'po_no' }), T('cost_type', 'Cost Type', 'select', { opts: ['Freight', 'Duties', 'Insurance', 'Handling', 'Bank Charges', 'Other'] }), T('amount', 'Amount', 'num'), T('notes', 'Notes', 'textarea')] },
  ...
  stations: { label: 'Stations', group: 'Asset Management', table: 'stations', seq: { prefix: 'STN', field: 'code' },
    search: ['code', 'name', 'location'], cols: [T('code', 'Code', 'ro'), T('name', 'Name', 'text'), T('location', 'Location', 'select', { lookup: 'locations', lv: 'name', ll: 'name' }), T('status', 'Status', 'select', { opts: ['ACTIVE', 'INACTIVE', 'MAINTENANCE'] })] },
  lockers: { label: 'Lockers', group: 'Asset Management', table: 'lockers', seq: { prefix: 'LKR', field: 'locker_no' },
    search: ['locker_no', 'station_code'], cols: [T('locker_no', 'Locker No', 'ro'), T('station_code', 'Station', 'select', { lookup: 'stations', lv: 'code', ll: 'name' }), T('slots', 'Battery Slots', 'num'), T('status', 'Status', 'select', { opts: ['ACTIVE', 'INACTIVE', 'MAINTENANCE'] })] },
  ...
  battery: { label: 'Battery Mapping', group: 'Asset Management', table: 'battery_mapping', date: 'mapped_date', seq: null,
    search: ['serial_no', 'station_code'], cols: [T('serial_no', 'Battery Serial', 'select', { lookup: 'serials', lv: 'serial_no', ll: 'serial_no' }), T('station_code', 'Station', 'select', { lookup: 'stations', lv: 'code', ll: 'name' }), T('locker_no', 'Locker', 'select', { lookup: 'lockers', lv: 'locker_no', ll: 'locker_no' }), T('customer_id', 'Customer', 'select', { lookup: 'customers', lv: 'id', ll: 'name' }), T('status', 'Status', 'text'), T('mapped_date', 'Mapped', 'date')] },
  // ---- Documents ----
